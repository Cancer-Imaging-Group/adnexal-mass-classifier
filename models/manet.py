...
class SegmentationHead(nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size=3, activation=None):
        super().__init__()
        self.conv = md.Conv2dReLU(in_channels, in_channels, kernel_size=kernel_size, padding=kernel_size // 2)
...
class MAnet(nn.Module):
    ...
    def initialize(self):
        # Initialize the weights, typically with He or Xavier initialization.
